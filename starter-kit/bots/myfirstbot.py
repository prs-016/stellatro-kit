"""
Smart greedy bot — picks the joker that gives the biggest advantage over the opponent.

Strategy:
For each candidate joker:
1. Estimate my best possible hand score if I take it.
2. Estimate how much the opponent would benefit if they got it.
3. Pick the joker that maximizes:
      my_score + deny_weight * opponent_gain

Then, during play, brute-force all C(10,5)=252 hand combos and play the best one.
"""
